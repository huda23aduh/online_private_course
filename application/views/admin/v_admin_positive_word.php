	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href=<?php echo base_url()."admin/positive_word"; ?>><img style="height: 20px;width:20px;" src=<?php echo public_url()."images/like.png" ?> /> Positive Word</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Positive Word</h1>
				<?php
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form action="<?php echo base_url(). 'positive_word/tambah_kata'; ?>" method="post">
							<table style="margin:20px auto;">
								<tr>
									<!-- <td>Kata Positif &nbsp;&nbsp;&nbsp;</td> -->
									<td><input type="text" placeholder="Add new . . . " name="kata_positif">&nbsp;&nbsp;&nbsp;</td>
									<td><button type="submit"><img style="height: 20px;width:20px;" src=<?php echo public_url()."images/add.png" ?> /></button></td>
									
									<!-- <td><input type="text" name="kata_positif">&nbsp;&nbsp;&nbsp;</td>
						            ...
						            <?php 
						            	...
						            	//var_dump($list);
						           		...
						           		foreach ($results as $value) {
						           			...
						           			echo "<td>"; echo $value->idkata_positif."</td><td>".$value->kata."</td>";
						           			echo "<td>"; echo "<a href=".base_url().'positive_word/hapus_kata/'.$value->idkata_positif.">hapus</a>" ."</td>";
						           			echo "</tr>";
										}
