	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href=<?php echo base_url()."admin/venue"; ?> ><img style="height: 30px;width:30px;" src=<?php echo public_url()."images/venue_logo.png" ?> /> Venue</a></li>
					            ...
					            <?php 
					            	...
					            	//var_dump($list);
					           		...
					           		foreach ($results as $value) {
					           			...
					           			echo "<td>"; echo $value->foursquare_venue_id."</td><td>".$value->name."</td><td>".$value->formatted_address."</td><td>"."<a href=".base_url()."admin/venue_detail/".$value->foursquare_venue_id." target='_blank'>Visit </a></td>";
					           			echo "</tr>";
									}
