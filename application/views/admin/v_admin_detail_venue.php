	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Venue Details</h1>
				<?php
					...
					foreach ($var_venue_info as $value1) {
						echo "<h4>".$value1->name."</h4>";
						echo "<h4>".$value1->country."</h4>";
						  ...
						  <table class="table">
						    ...
						    <tbody>
					            <?php 
					            	...
					            	//var_dump($the_tips_array);
					            	
					            	for($i=0; $i < count($the_tips_array); $i++){
					            		echo "<tr><td>".($i+1)."</td><td>".$the_tips_array[$i][0]."</td><td>".$the_tips_array[$i][1]."</td><td>".$the_tips_array[$i][2]."</td><td>".$the_tips_array[$i][3]."</td></tr>";
					            	}
					           		
					    //        		foreach ($var_tips as $value) {
					    //        			echo "<tr>";
					    //        			echo "<td>".$value->tip_text."</td><td>".$value->tip_username."</td><td>".$value->tip_date."</td>";
					    //        			echo "</tr>";
									// }
