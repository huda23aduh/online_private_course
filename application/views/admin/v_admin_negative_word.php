	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href=<?php echo base_url()."admin/negative_word"; ?> ><img style="height: 20px;width:20px;" src=<?php echo public_url()."images/dislike.png" ?> /> Negative Word</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Negative Word</h1>
				<?php
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<form action="<?php echo base_url(). 'negative_word/tambah_kata'; ?>" method="post">
							<table style="margin:20px auto;">
								<tr>
									<!-- <td>Kata Negatif &nbsp;&nbsp;&nbsp;</td> -->
									
									<td><input type="text" placeholder="Add new . . . " name="txt_kata_negatif">&nbsp;&nbsp;&nbsp;</td>
									<td><button type="submit"><img style="height: 20px;width:20px;" src=<?php echo public_url()."images/add.png" ?> /></button></td>
									

									<!-- <td><input type="text" name="txt_kata_negatif">&nbsp;&nbsp;&nbsp;</td>
					            ...
					            <?php 
					            	...
					            	//var_dump($list);
					           		...
					           		foreach ($results as $value) {
					           			...
					           			echo "<td>"; echo $value->idkata_negatif."</td><td>".$value->kata."</td>";
					           			echo "<td>"; echo "<a href=".base_url().'negative_word/hapus_kata/'.$value->idkata_negatif.">hapus</a>" ."</td>";
					           			echo "</tr>";
									}
