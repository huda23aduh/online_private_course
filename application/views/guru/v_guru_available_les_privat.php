	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Tawaran Les Privat</h1>
			</div>
		</div><!--/.row-->
			...
			<div class="col-lg-12" style="background-color:#c2c2a3;">
				...
				<table class="table">
				  ...
				  <tbody>
				    	...
				    	<?php
				    		if($all_available_les_privat_guru != null){
				    			foreach ($all_available_les_privat_guru as $value) {

									$ket_status = "";
									if($value->status_les_idstatus_les == 0)
										$ket_status = "sedang mencari guru";
									...
									echo "<td>".$ket_status."</td>";
									echo "<td><a href=".base_url()."les/assign_les/".$value->idles."/".$idguru.">AMBIL</a> </td>";
									echo "</tr>";
								}
				    		}
