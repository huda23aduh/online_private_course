	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<form class="form-horizontal" action=<?php echo base_url()."guru_pelajaran/create"?> method="post">
	      			<table border="0px" class="table-responsive">
	      				<tr>
	      					<td>
	      						<div class="form-group">
								    <div class="col-sm-10">
								      <h4>ID Guru</h4><input type="text" class="form-control" id="idguru" value=<?php echo $idguru; ?> name="idguru" readonly size="40">
								    </div>
