	...
	<script>
		$("#durasi").change(function () {
			var durasi_val = $('#durasi').val();
			var tarif_val = parseInt(durasi_val) * 20000;
		    var rec = $("#tarif");
		    rec.val(tarif_val);
	 ...
	 $(document).ready(function() {
	    ...
	    $("#refresh_btn").click(function() {  
		    ...
		    $.ajax({    //create an ajax request to display.php
		        type: "GET",
		        url: <?php echo '"'.base_url().'murid_notification/getTotalUnOpenedNotifDataByIdmurid/'.$idmurid.'"'; ?> ,             
		        ...
		        success: function(response){  
		        	...
		        	for (var i in details_notif) {
		        		$('#ul_notif').append('<li><a href=google.com> <div><em class=fa fa-envelope></em>' + 'ddddddddd' + d.details[i].idnotification + d.details[i].information +
