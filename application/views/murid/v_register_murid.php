    	...
    	<div class="container text-center"  >
	        ...
	        <!-- <p class="lead">DESKRIPSI WEBSITE</p> -->
	      	...
	      	<div class="col-md-8 col-md-offset-8">
	      		...
	      		<form class="form-horizontal" action=<?php echo base_url()."murid/create"?> method="post">
				  ...
				  <div class="form-group"> 
				    <div class="col-md-8 col-md-offset-8">
				      <button type="submit" class="btn btn-success btn-lg btn-block">Daftar Sebagai Murid</button>
				    </div>
				  </div>
				</form>
